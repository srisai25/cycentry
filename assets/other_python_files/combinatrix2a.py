...
from .RunModel_1 import *
from .RunModel_2 import *
from .RunModel_3 import *
from .RunModel_4 import *
from .RunModel_5_ver2 import *
...
def maha_predicto(s):
    ...
    if(remo.endswith(".dll")):
        ...
        try:
            ...
            p1=predicto_1(s)
            err_2,p2=predicto_2(s)
            err_3,p3=predicto_3(s)
            err_4,p4=predicto_4(s)
            p5=predicto_5(s)
